  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        measureControl: resolve(__dirname, 'examples/measure-control/index.html'),
        coordinateControl: resolve(__dirname, 'examples/coordinate-control/index.html'),
        bookmarkControl: resolve(__dirname, 'examples/bookmark-control/index.html'),
      },
    },
  },
  resolve: {
